  ...
  return (
    <div data-aos="fade-left" className=" mt-8 custom:w-full">
      ...
      <p className="text-xl font-primary ml-0 md:ml-10">
        ...
        Within his time with the military, he has dabbled with networking concepts and equipment, cybersecurity practices and satellite communication fundamentals. 
        He has shown a consistent history of having a focused mindset, strict work ethic but also an eager attitude to learn new things.
      ...
      <p1 className="text-xl font-primary ml-0 md:ml-10">
