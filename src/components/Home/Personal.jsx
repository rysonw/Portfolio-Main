  ...
  return (
    <div data-aos="fade-left" className=" mt-8 custom:w-full">
      ...
      <p className="text-xl font-primary ml-0 md:ml-10 text-align justify">
        ...
        In his free time, he tries to further his programming skills by working on personal projects and solidifying core programming concepts through books and MOOC's.<br />
        <br />
        ...
        After finishing up his fellowship with MLH and Meta this past August, Ryson has recently commited to Microsoft's Software and Systems Academy where he plans to use this pathway to earn a full-time SWE postions at Microsoft.
        He is attending the Cloud Applicaton Development Pathway and hopes to learn as much about Cloud Devlopment and come out of the program with great projects to showcase.<br />
        <br />
